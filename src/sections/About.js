  ...
  return (
    <div>
      <Documentation>
        ...
        <ol>
          <li>Many garden technologies represent gardening as a solitary, single season activity. In contrast, AGC views gardening as a collaborative activity, with support for gaining insights over multiple seasons by all of a member&lsquo;s local gardening community.</li>
          ...
          <li>AGC data is Chapter-specific. If you live in Alaska, garden data from Florida is of limited use. The AGC community is divided into local Chapters covering a small geographic region. This helps ensure the relevance of community-supplied data on plant and seed outcomes.</li>
        </ol>
