...
function About() {
  ...
  return (
    <Documentation>
      ...
      <p><b>Agile Garden Club</b> is an organization providing technology for collaborative planning and management of home gardens. We are designing mobile-first applications to support not just individual garden planning and management, but also efficient and effective sharing of data and insights amongst gardeners in the same geographic region.</p>
      <p><em>Our support for collaboration, for historical insights over multiple seasons, and for &quot;local communities of practice&quot; sets AGC apart from other garden planning systems.</em></p>
