...
function About() {
  ...
  return (
    <Documentation heading="About Agile Garden Club and the Public Garden View">
      <p>Welcome to this example of an Agile Garden Club public garden view.</p>
      <p><b>Agile Garden Club</b> is an organization providing technology for collaborative planning and management of home gardens. We are developing mobile-first applications to support not just garden planning, but also to support efficient and effective sharing of data and insights amongst gardeners in the same geographic region. Our support for collaboration, for historical insights over multiple seasons, and for &quot;local communities of practice&quot; sets AGC apart from other garden planning systems.</p>
