...
export const varietyData = [
  ...
  },
  {
    id: 'variety-225',
    cropID: 'crop-30',
    variety: 'Lunchbox Red Pepper',
    vendorID: 'vendor-08',
    description: 'A classic sweet red pepper.',
    daysToHarvest: 45,
  },
  {
    id: 'variety-226',
    ...
    vendorID: 'vendor-08',
    description: 'A sweet, horn-shaped red pepper.',
    daysToHarvest: 45,
  },
  {
    id: 'variety-227',
  ...
  },
  {
    ...
    variety: 'Romaine',
    vendorID: 'vendor-12',
    description: 'Tall heads of sturdy, dark leaves with firm ribs down the center.  Heat tolerant.',
    daysToHarvest: 60,
  },
  {
    id: 'variety-236',
    cropID: 'crop-45',
    variety: 'Northern Ruby Paste',
    vendorID: 'vendor-02',
    description: 'Determinate.  Short, bushy plants are nearly solid bricks of fruit starting to ripen very early and continuing for us until frost or blight does them in.',
    daysToHarvest: 70,
  },
  {
    id: 'variety-237',
  ...
  },
  {
    id: 'variety-238',
    cropID: 'crop-05',
    variety: 'San Bernando Blue',
    vendorID: 'vendor-02',
    description: 'A dry, pole bean.  Tall, vigorous and productive climbing vines hang heavy with pods.  Sometimes known  as "Nonna Agnes blue bean."',
    daysToHarvest: 110,
  },
];
